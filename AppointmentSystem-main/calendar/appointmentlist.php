...
require '../calendar/db_connection.php';
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST">
                            ...
                            <button type="submit" name="update" class="btn btn-success" onclick="this.form.new_status.value='confirmed';">Confirm</button>
                            <button type="submit" name="update" class="btn btn-danger" onclick="this.form.new_status.value='cancelled';">Cancel</button>
